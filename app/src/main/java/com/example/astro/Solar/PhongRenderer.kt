...
class PhongRenderer(private val context: Context, private val selectedPlanetIndex: Int) : GLSurfaceView.Renderer {
    ...
    private val ambientColor = floatArrayOf(0.6f, 0.6f, 0.6f, 1.0f)  // Окружающий свет
    ...
    private val shininess = 64.0f                                     // Блеск
    ...
    fun getObjectTexture(index: Int): Int {
        return when (index) {
            ...
            8 -> R.drawable.moon8k
            9 -> R.drawable.sun8k
            else -> R.drawable.milky_way2
        }
    }

    companion object { // Волны
        private const val VERTEX_SHADER_CODE = """
            ...
            void main() {
                float waveHeight = 0.1 * sin(a_Position.x * 15.0 + u_Time) * sin(a_Position.z * 10.0 + u_Time);
